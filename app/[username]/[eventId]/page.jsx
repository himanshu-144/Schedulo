...
import EventDetails  from "./_eventComponent/EventsDetails";
import BookingForm  from "./_eventComponent/BookingForm"
...
export  async function generateMetadata({ params }) {
  ...
  return {
    title: `Book ${event.title} with ${event.user.name} | Schedulo`,
